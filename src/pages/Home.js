...
// 🧠 Custom Hook: fade/slide elements in when they enter the viewport
...
export default function Home() {
  ...
  useScrollReveal(); // trigger intersection-observer effect

  // 🔍 Track scroll position → highlight current section in dot-nav
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <>
      {/* Dot Navigation (right-side bullets) */}
      <nav className="dot-nav">
        {["home", "choose", "promise", "blogs"].map((id) => (
          <a
            key={id}
            href={`#${id}`}
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Creonox, a top mobile app development company India, builds Android, iOS, Flutter, AI apps designed to grow your business."
        />
      </Helmet>
      ...
      <section id="home" className="home-body reveal-on-scroll">
        <div className="bodymain">
          ...
          <p className="reveal-on-scroll">
            Modern, responsive, and high-converting websites tailored to your
            brand.
          </p>
      ...
      <section id="promise" className="promise-section reveal-on-scroll">
        ...
        <p className="promise-intro reveal-on-scroll1">
          At Creonox, we understand that trust is earned — and we’re here to earn
          yours.
        </p>
        ...
        <div className="promise-grid">
          ...
          <h2 className="reveal-on-scroll">
            <em>
              “We're not just building websites. We're building your trust — one
              project at a time.”
            </em>
          </h2>
        </div>
      ...
      <section id="blogs" className="blogs-section reveal-on-scroll">
        ...
        <p className="blogs-subtext reveal-on-scroll">
          Stay updated with smart tips, tech trends, and expert insights from
          the Creonox team.
        </p>
        ...
        <div className="blog-grid">
          {[
            ...
            <div className="blog-card reveal-on-scroll" key={i}>
              ...
              <h4>{blog.title}</h4>
              <p>{blog.desc}</p>
              {/* 👉 fixed: Link itself acts as anchor */}
              <Link to={blog.link} className="learn-more-link">
                Learn more…
              </Link>
            </div>
          ))}
        ...
        <Link to="/Blogs">
          <button className="explore-button reveal-on-scroll">
            Explore Blogs
          </button>
        </Link>
      </section>
      ...
      <footer className="footer">
        ...
        <p className="footer-bottom reveal-on-scroll">
